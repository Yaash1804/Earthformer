# ==============================================================================
# SCRIPT FOR EVALUATING THE GENERALIZATION OF THE (TEACHER + STUDENT) MODEL
#
# (Version 10 - Fixes NameError for 'scenario')
#
# ==============================================================================
...
def plot_comparison(actuals_denorm, preds_denorm, time_axis, title, save_path, y_ticks):
    """
    ...
    try:
        ...
        ax.plot(time_axis, preds_denorm, label='Predicted SST', 
...
def run_evaluation_for_patch(
    ...
    plot_comparison(
        ...
        time_axis,
        title=f"Teacher+Student Forecast vs. Actual\nPatch: {scenario_name}",
        save_path=os.path.join(plot_save_dir, f"student_corrected_{scenario_name}.png"),
        y_ticks=y_ticks
    )
    # --- END OF FIX ---
...
def get_args_parser():
    ...
    parser = argparse.ArgumentParser(description='Teacher-Student Generalization Evaluation Script')
    ...
    parser.add_argument('--plot_save_dir', type=str, default='evaluation_plots')
...
def main():
    ...
    # --- 4. Define 3 New Scenarios (P1, P2, P3) ---
    # P0 (Student's training) was lon="72.375:79.125"
    # Patch width is 6.75 degrees. 50% shift is 3.375 degrees.
    scenarios = [
        {
            "name": "Shift_East_50_P1",
            "center_lat": 18.125,
            "center_lon": 79.125 # 75.75 + 3.375
        },
        {
            "name": "Shift_East_50_P2",
            "center_lat": 18.125,
            "center_lon": 82.5 # 79.125 + 3.375
        },
        {
            "name": "Shift_East_50_P3",
            "center_lat": 18.125,
            "center_lon": 85.875 # 82.5 + 3.375
        },
    ]

    # --- 5. Loop through scenarios and generate 6 plots ---
